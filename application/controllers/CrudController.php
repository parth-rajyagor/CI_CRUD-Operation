...
class CrudController extends CI_Controller {
    ...
    public function add_data() {
        ...
        if($this->form_validation->run()){
            ...
            if(!$this->upload->do_upload('image')){
                ...
                if($check){
                    $this->session->set_flashdata('successMsg', 'Data has been inserted successfully');
    ...
    public function update_data() {
        ...
        if($this->form_validation->run()){
            ...
            if($check){
                $this->session->set_flashdata('updateMsg', 'Data has been updated successfully');
                redirect('crudcontroller/all_data');
            }
        }
        else {
    ...
    public function delete_data($id) {
        ...
        if($check) {
            $this->session->set_flashdata('deleteMsg', 'Data has been deleted successfully');
            redirect('crudcontroller/all_data');
        }
    }
}
